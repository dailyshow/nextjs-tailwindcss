...
export default function Home() {
  return (
    <Layout>
      ...
      {/* grid url = https://tailwindcss.com/docs/display#grid */}
      <div class="grid grid-cols-10 gap-2">
        {/* aspect-ratio url = https://tailwindcss.com/docs/aspect-ratio#browser-support */}
        <div class="bg-sky-50 aspect-square"></div> {/* aspect-square = aspect-ratio: 1/1 */}
